...
rem провер€ем корректность кодировани€/декодировани€ с помощью данных, найденных вручную
...
rem провер€ем корректность кодировани€/декодировани€
...
rem ќжидаем ненулевой код ошибки при:
...
rem невозможность записи в выходной файл (в исполн€емый файл программы)
